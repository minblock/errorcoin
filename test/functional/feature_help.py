...
"""Verify that starting errorcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start errorcoin with -h for help text")
        ...
        self.log.info("Start errorcoin with -version for version information")
        ...
        self.log.info("Start errorcoind with -fakearg to make sure it does not start")
