# Support for Output Descriptors in errorcoin Core

Since errorcoin Core v0.17, there is support for Output Descriptors. This is a
...
on errorcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing errorcoin Core wallets, a convenience function `combo` is
