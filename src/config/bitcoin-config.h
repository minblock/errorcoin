...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The errorcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "errorcoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/errorcoin-project/errorcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "errorcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "errorcoin Core 0.18.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "errorcoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://errorcoin.org/"
