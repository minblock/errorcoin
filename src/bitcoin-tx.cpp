...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " errorcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  errorcoin-tx [options] <hex-tx> [commands]  Update hex-encoded errorcoin transaction\n" +
            "or:     errorcoin-tx [options] -create [commands]   Create hex-encoded errorcoin transaction\n" +
            "\n";
