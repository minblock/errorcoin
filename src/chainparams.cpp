...
{
    const char* pszTimestamp = "4/2/2020 Provigen Networks: Now accepting seversCRTz";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1586337810, 609196, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x09cebe243ff8bb8269743f0eb004276818ba00c958ea047b0f6da2f6bc954d4f"));
        assert(genesis.hashMerkleRoot == uint256S("0x1756e8ea46a6ee1e84bf574df236b310a3677204fb5d02c25e0e65b87e70ce72"));
        ...
        vSeeds.emplace_back("seed-a.errorcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.errorcointools.com");
        vSeeds.emplace_back("dnsseed.errorcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 1012161, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc0fbf8a2a288bdf6ae11084ba044e722108b97e055abbd3cdcbea46afced183b"));
        assert(genesis.hashMerkleRoot == uint256S("0x1756e8ea46a6ee1e84bf574df236b310a3677204fb5d02c25e0e65b87e70ce72"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.errorcointools.com");
        vSeeds.emplace_back("seed-b.errorcoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x02a1a82b910062ec8de6c026acf222806d324704f7eca80a2932319c6a024d87"));
        assert(genesis.hashMerkleRoot == uint256S("0x1756e8ea46a6ee1e84bf574df236b310a3677204fb5d02c25e0e65b87e70ce72"));
