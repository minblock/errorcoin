...
pkgdatadir = $(datadir)/errorcoin
pkgincludedir = $(includedir)/errorcoin
pkglibdir = $(libdir)/errorcoin
pkglibexecdir = $(libexecdir)/errorcoin
...
ACLOCAL = ${SHELL} /errorcoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /errorcoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /errorcoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /errorcoin/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = errorcoin-cli
BITCOIN_DAEMON_NAME = errorcoind
BITCOIN_GUI_NAME = errorcoin-qt
BITCOIN_TX_NAME = errorcoin-tx
BITCOIN_WALLET_TOOL_NAME = errorcoin-wallet
...
COPYRIGHT_HOLDERS_FINAL = The errorcoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = errorcoin Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /errorcoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = errorcoin
PACKAGE_BUGREPORT = https://github.com/errorcoin-project/errorcoin/issues
PACKAGE_NAME = errorcoin Core
PACKAGE_STRING = errorcoin Core 0.18.1
PACKAGE_TARNAME = errorcoin
PACKAGE_URL = https://errorcoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /errorcoin
abs_srcdir = /errorcoin
abs_top_builddir = /errorcoin
abs_top_srcdir = /errorcoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /errorcoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/errorcoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/errorcoin-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/errorcoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/errorcoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
